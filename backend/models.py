...
class PatrakEntry(Base):
    ...
    sender_type = Column(String(50), nullable=False, default="Citizen")
    ...
    receiving_mode = Column(String(20), nullable=False, default="By Hand")
    ...
    sender_reference_number = Column(String(100), nullable=True)
